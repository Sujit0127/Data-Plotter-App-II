...
class GUI(QWidget):
    ...
    def make_Header(self):
        ...
        self.tim = QtGui.QPixmap("H:\\My_Application\\matplot_qt_01082024\\matplot_qt\\1\\DRDL.png")
        ...
        self.tim = QtGui.QPixmap("H:\\My_Application\\matplot_qt_01082024\\matplot_qt\\1\\demo.png")
        ...
        self.title_label.setStyleSheet("font-size: 40px; color: white; border-radius: 10px;")
        ...
        self.submit_button_1 = QPushButton("Open Application 1", self)
        ...
        self.submit_button_2 = QPushButton("Open Application 2", self)
        ...
        self.submit_button_3 = QPushButton("Open Application 3", self)
    ...
    def make_Footer(self):
        ...
        self.footer_label = QLabel("© Developed by Sujit--RSD.")
    ...
    def submit_clicked_1(self):
        ...
        subprocess.Popen(['python', 'H:\\My_Application\\matplot_qt_01082024\\matplot_qt\\1\\PLOTTER_APP_1FIG.py'])

    def submit_clicked_2(self):
        print(">>>>>>> SUJIT---BUTTON-2 Clicked")
        subprocess.Popen(['python', 'H:\\My_Application\\matplot_qt_01082024\\matplot_qt\\1\\PLOTTER_APP_D3.py'])

    def submit_clicked_3(self):
        print(">>>>>>> SUJIT---BUTTON-3 Clicked")
        subprocess.Popen(['python', 'H:\\My_Application\\matplot_qt_01082024\\matplot_qt\\1\\PDF_GE.py'])
